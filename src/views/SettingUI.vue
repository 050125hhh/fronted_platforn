          ...
          <el-form label-width="180px" class="settings-form">
            ...
            <el-form-item label="黑名单阈值 (%)">
              <el-slider
                ...
                class="setting-slider"> <!-- 去掉了 disabled 属性 -->
              </el-slider>
...
const port = ref(8080); // 初始端口
const delay = ref(100); // 初始延迟
const logPath = ref('/var/log/app.log'); // 初始日志路径
const resPath = ref('/var/respath'); // 初始静态文件路径
const blackThreshold = ref(10); // 初始黑名单阈值
...
const submitModify = async () => {
  ...
  switch (modifyType.value) {
    ...
    case 'resPath':
      ...
      break;
    case 'blackThreshold':
      url = 'http://localhost:8000/blackthreshold';
